...
#    assert_equal '20899', @context.eval('e2e_patient.immunizations()[3].performer().person().addresses()[0].postalCode()')
    ...
    assert_equal 2012, @context.eval('e2e_patient.immunizations()[0].date().getUTCFullYear()')
    assert_equal 8, @context.eval('e2e_patient.immunizations()[0].date().getUTCMonth()')
    assert_equal 1, @context.eval('e2e_patient.immunizations()[0].date().getUTCDate()')
